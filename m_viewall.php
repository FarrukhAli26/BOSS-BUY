...
$query = "SELECT product_name, price, product_id FROM projtest.product WHERE category_id=3";
...
for ($i = 0; $i < count($name); $i++) {
    ...
    $div_contents[] = '
    <div class="col-md-3">
    <a href="'.$name[$i].'.php"> <img src="men/'.$name[$i].'.avif"/></a>
...
<div style="margin: 53px 0px 20px 66px;"><h1 ><b style="border: 1px solid black; border-radius: 5px; padding: 2px 7px 2px 7px;">MEN'S CLOTHES</b></h1></div>
...
<div class="container-fluid" style="display: flex; padding: 0px; margin-top: 35px">
    <div class="row" style="width: 7%; margin: 0px 0px 0px 64px">
        <a href="m_viewall.php"><button style="background-color: transparent; border: 1px solid black; color: black; font-size: 15px;">CLOTHES</button></a>
    </div>
    <div class="row" style="width:">
        <a href="m_accessories.php"><button class="accessories" style="background-color: transparent; border: 1px solid black; color: black; font-size: 15px; margin-left: 25px">ACCESSORIES</button></a>
    </div>
</div>
...
<div class="container-fluid">
	<div class="row" style="display: flex;">
		<!-- <div class="col-md-3">
			<a href="sequinedshirt.php"><img src="men/sequinedshirt.avif"></a>
			<div class="product-title"><b>REGULAR FITTED SEQUINED SHIRT</b></div>
            <div class="price"><b>$59.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="boot.php"><img src="men/boot.avif"></a>
            <div class="product-title"><b>RHINESTONE EMBELLISHED BOOTS</b></div>
            <div class="price"><b>$89.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="belt.php"><img src="men/belt.avif"></a>
            <div class="product-title"><b>LEATHER BELT</b></div>
            <div class="price"><b>$34.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="sweatshirt.php"><img src="men/sweatshirt.avif"></a>
            <div class="product-title"><b>LOOSE FIT RIBBED SWEATSHIRT</b></div>
            <div class="price"><b>$39.99</b></div>
		</div> -->
	...
	<div class="row" style="display: flex; margin-top: 44px;">
		<!-- <div class="col-md-3">
			<a href="looseshirt.php"><img src="men/looseshirt.avif"></a>
            <div class="product-title"><b>LOOSE FIT LONG-SLEEVED JERSEY SHIRT</b></div>
            <div class="price"><b>$34.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="bomberjacket.php"><img src="men/bomberjacket.avif"></a>
            <div class="product-title"><b>REGULAR FIT JERSEY BOMBER JACKET</b></div>
            <div class="price"><b>$49.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="blackshirt.php"><img src="men/blackshirt.avif"></a>
            <div class="product-title"><b>REGULAR-FIT SHIRT WITH SCARF COLLAR</b></div>
            <div class="price"><b>$49.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="turtleneck.php"><img src="men/turtleneck.avif"></a>
            <div class="product-title"><b>SLIM FIT SHIMMERY MOCK TURTLENECK SWEATER</b></div>
            <div class="price"><b>$49.99</b></div>
		</div> -->
