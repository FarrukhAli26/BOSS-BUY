...
$query = "SELECT product_name, price, product_id FROM projtest.product WHERE category_id=1";
...
$con->close();
// } // Uncomment the closing brace if you want to handle POST submission
...
<!-- <div style="margin: 53px 0px 20px 66px;"><h1 ><b style="border: 1px solid black; border-radius: 5px; padding: 2px 7px 2px 7px;">VIEW ALL</b></h1></div> -->
<div style="margin: 53px 0px 20px 66px;"><h1 ><b style="border: 1px solid black; border-radius: 5px; padding: 2px 7px 2px 7px;">WOMEN'S CLOTHES</b></h1></div>
<br>
...
<div class="container-fluid">
	<div class="row" style="display: flex;">
		<!-- <div class="col-md-3">
			<a href="embellishedshirt.php"><img src="women/embellishedshirt.avif"></a>
			<div class="product-title"><b>OVERSIZED RHINESTONE-EMBELLISHED SHIRT</b></div>
            <div class="price"><b>$34.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="maxiskirt.php"><img src="women/maxiskirt.avif"></a>
			<div class="product-title"><b>JERSEY MAXI-SKIRT</b></div>
            <div class="price"><b>$19.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="ziptop.php"><img src="women/ziptop.avif"></a>
			<div class="product-title"><b>COLLARED ZIP-THROUGH TOP</b></div>
            <div class="price"><b>$17.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="cardigan.php"><img src="women/cardigan.avif"></a>
			<div class="product-title"><b>BUTTON-DETAILED CARDIGAN</b></div>
    ...
    <div class="row" style="display: flex;">
      <!-- <div class="col-md-3">
         <a href="flaredskirt.php"><img src="women/flaredskirt.avif"></a>
         <div class="product-title"><b>FLARED-SKIRT TWILL DRESS</b></div>
         <div class="price"><b>$49.99</b></div>
     </div>
     <div class="col-md-3">
         <a href="mules.php"><img src="women/mules.avif"></a>
         <div class="product-title"><b>HEELED MULES</b></div>
         <div class="price"><b>$49.99</b></div>
     </div>
     <div class="col-md-3">
         <a href="weave.php"><img src="women/weave.avif"></a>
         <div class="product-title"><b>JACQUARD-WEAVE MINI DRESS</b></div>
         <div class="price"><b>$29.99</b></div>
     </div>
     <div class="col-md-3">
         <a href="coat.php"><img src="women/coat.avif"></a>
         <div class="product-title"><b>TUXEDO BLAZER</b></div>
         <div class="price"><b>$74.99</b></div>
     </div> -->
