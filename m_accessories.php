...
$query = "SELECT product_name, price, product_id FROM projtest.product WHERE category_id=4";
...
<div style="margin: 53px 0px 20px 66px;"><h1 ><b style="border: 1px solid black; border-radius: 5px; padding: 2px 7px 2px 7px;">MEN'S ACCESSORIES</b></h1></div>
...
<div class="container-fluid">
	<div class="row" style="display: flex;">
		<!-- <div class="col-md-3">
			<a href="chain.php"><img src="men/chain.avif"></a>
			<div class="product-title"><b>RHINESTONE NECKLACE</b></div>
            <div class="price"><b>$14.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="glasses.php"><img src="men/glasses.avif"></a>
            <div class="product-title"><b>BLUE LIGHT GLASSES</b></div>
            <div class="price"><b>$14.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="cap.php"><img src="men/cap.avif"></a>
            <div class="product-title"><b>DENIM CAP</b></div>
            <div class="price"><b>$9.99</b></div>
		</div>
		<div class="col-md-3">
			<a href="sunglasses.php"><img src="men/sunglasses.avif"></a>
            <div class="product-title"><b>POLARIZED SUNGLASSES</b></div>
	...
	<div class="row" style="display: flex; margin-top: 44px;">
		<!-- <div class="col-md-3">
			<a href="gloves.php"><img src="men/gloves1.avif"></a>
            <div class="product-title"><b>LEATHER GLOVES</b></div>
